...
export const DashboardService = {
    getMetrics: async () => {
        ...
        const [totalOrders, todayOrders, totalSalesAgg, todaySalesAgg, statusCountsRaw, lowStockProducts] = await Promise.all([
            prisma.order.count(),
    ...
    getCharts: async (period, year) => {
        ...
        if (period === 'yearly') {
            ...
            const monthMap = monthNames.reduce((acc, m) => { acc[m] = 0; return acc; }, {});
            orders.forEach(o => {
